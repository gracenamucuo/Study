...
@interface ETAutoFooterController ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,strong)UITableView *tableView;
@property (nonatomic,assign)NSInteger count;

@end
static NSString *cellID = @"cellID";
@implementation ETAutoFooterController
...
- (void)layoutUI
{
    ...
    [self.tableView et_autoGifFooterWithRefreshingBlock:^{
        NSLog(@"------");
        weakSelf.count += 10;
