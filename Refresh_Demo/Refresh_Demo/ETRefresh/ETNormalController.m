...
@interface ETNormalController ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,strong)UITableView *tableView;
@property (nonatomic,assign)NSInteger count;
@end
static NSString *cellID = @"cellID";
@implementation ETNormalController
...
- (void)layoutUI
{
    ...
    [self.tableView et_normalHeaderWithRefreshingBlock:^{
        NSLog(@"%@",[weakSelf class]);
    }];
    
    [self.tableView et_backNormalFooterWithRefreshingBlock:^{
        weakSelf.count += 10;
