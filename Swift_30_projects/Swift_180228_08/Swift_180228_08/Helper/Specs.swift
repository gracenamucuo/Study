...
public struct Specs {
    public struct Color{
        public let tint = UIColor.init(hex: 0x3b5998)
    ...
    public struct Font{
        ...
        public let tiny = UIFont.init(name: regularName, size: Specs.fontSize.tiny)
        public let small = UIFont.init(name: regularName, size: Specs.fontSize.small)
        public let regular = UIFont.init(name: regularName, size: Specs.fontSize.regular)
        public let large = UIFont.init(name: regularName, size: Specs.fontSize.large)
