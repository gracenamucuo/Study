 ...
 */
- (void)insertTable:(NSString *)tableName inDataBase:(NSString*)dbName modelArray:(NSArray *)modelArray completion:(void(^)(NSArray *unInsertArray))completion;
...
/**
 ...
 @return 数组 小于等于10
 */
- (void)acquireTenModelsBeforeModel:(id)model tableName:(NSString *)tableName inDataBase:(NSString *)dbName completion:(void(^)(NSArray *data))completion;
